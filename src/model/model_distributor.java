...
public class model_distributor {
    ...
    public String getEmail_distributor() {
        return email_distributor;
    }

    public void setEmail_distributor(String email_distributor) {
        this.email_distributor = email_distributor;
    }
       ...
       private String nama_distributor;
        private String alamat_distributor;
         private String telp_distributor;
          private String email_distributor;
